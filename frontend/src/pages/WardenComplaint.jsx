...
const WardenComplaints = () => {
  ...
  const handleApproval = async (id) => {
    try {
      ...
      // Reload the complaints list instead of the whole page for a better UX
      getComplaints();
      // window.location = "/"; // This also works, but getComplaints() is smoother
    } catch (err) {
      console.error(err.message);
    }
  };
